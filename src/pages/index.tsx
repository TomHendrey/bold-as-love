...
const Home: React.FC = () => {
    ...
    const decadeContent: Record<DecadeType, DecadeContent> = {
        '1950s': {
            ...
            description: "Transport your guests back to the birth of rock 'n' roll with our authentic 50s sound. From Chuck Berry to Elvis Presley, we recreate the music that changed the world.",
        },
        '1960s': {
            title: 'Psychedelic Revolution',
            subtitle: 'Peace, love, and unforgettable music',
            description: 'Experience the sounds of Hendrix, The Beatles, and the Summer of Love. Our 60s repertoire captures the spirit of a generation that redefined music forever.',
        },
        '1970s': {
            title: 'Disco Dynamite',
            subtitle: 'Get down and boogie',
            description: "Turn your reception into Studio 54 with our authentic disco sound. From ABBA to the Bee Gees, we'll keep your dance floor packed all night long.",
        },
        '1980s': {
            title: 'Neon Nights',
            subtitle: 'Big hair, big sound',
            description: "Synth-pop, new wave, and hair metal - our 80s set brings the energy of MTV's golden era to your special day.",
        },
        '1990s': {
            title: 'Alternative Edge',
            subtitle: 'When music got real',
            description: 'From grunge to Britpop, our 90s selections capture the raw energy and authenticity that defined the decade.',
        },
        '2000s': {
            title: 'Digital Fusion',
            subtitle: 'Where genres collide',
            description: 'Pop punk, R&B, indie rock - the 2000s had it all, and so do we. Our millennial playlist bridges the gap between classic and contemporary.',
        },
        '2010s': {
            title: 'Minimalist Pulse',
            subtitle: 'Modern classics for modern celebrations',
            description: 'From Adele to Arctic Monkeys, our 2010s collection features the songs that will be remembered for generations.',
        },
        '2020s': {
            title: 'Hybrid Reality',
            subtitle: "Tomorrow's classics today",
            description: "The newest hits with timeless appeal - our contemporary selections showcase the best of today's music scene.",
        },
    };
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-12">
                <div className="rounded-lg p-6 bg-gray-800 shadow-lg">
                    ...
                    <button className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">Book Now</button>
                </div>
            </section>
